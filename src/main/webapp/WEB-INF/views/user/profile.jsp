    ...
    <div class="profileContainer">
        ...
        <div class="profile-right">
            <div class="name-group">
                ...
                <c:choose>
                    <c:when test="${user.pageOwnerState}">
                        <button class="cta" onclick="location.href='/image/upload'">사진등록</button>
                    </c:when>
                    <c:otherwise>
                        <c:choose>
                            <c:when test="${user.subscribeState}">
            ...
            <div class="subscribe">
                <ul>
                    <li><a href=""> 게시물<span>${user.imageCount}</span>
                    </a></li>
                    <li><a href="javascript:subscribeInfoModalOpen(${user.id});"> 구독정보<span>${user.subscribeCount}</span>
                    </a></li>
                </ul>
            </div>
            <div class="state">
...
<div class="modal-image" onclick="modalImage()">
    <div class="modal">
        <p>프로필 사진 바꾸기</p>
        <button onclick="profileImageUpload(${user.id}, ${principal.user.id})">사진 업로드</button>
